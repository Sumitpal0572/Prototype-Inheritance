...
let y = new Dog("Buddy", "Woof", "Labrador");

console.log(y);
console.log(y.name); // Output: Buddy
console.log(y.breed); // Output: Labrador

y.makeSound(); // Output: Woof

y.fetch(); // Output: Buddy fetches the ball!